...
__Vectors
    ...
    AREA lab_5_q1_insertion_sort_improved, CODE, READONLY
    ENTRY
...
; R11 previous smallest idx


; This improved version stops if the smallest idx didn't change
; across two outer loop iterations
...
SORT_INNER_LOOP
    ...
    CMP R5, R1
    BGE CHECK                       ; continue inner loop as long as j < n
...
CHECK
    CMP R6, R11    
    BEQ STOP                        ; quit if smallest idx was not updated
